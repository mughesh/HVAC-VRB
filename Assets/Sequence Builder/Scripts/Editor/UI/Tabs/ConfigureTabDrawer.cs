...
public class ConfigureTabDrawer
{
    ...
    {
        string folderPath = "Assets/SequenceBuilder/Resources";

        // Create folders if they don't exist
        if (!AssetDatabase.IsValidFolder("Assets/SequenceBuilder"))
        {
            AssetDatabase.CreateFolder("Assets", "SequenceBuilder");
        }
        if (!AssetDatabase.IsValidFolder(folderPath))
        {
            AssetDatabase.CreateFolder("Assets/SequenceBuilder", "Resources");
        }
