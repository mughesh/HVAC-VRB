...
namespace VRTrainingKit.ExportTools
{
    public class PackageExporter : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            bool pluginsExist = Directory.Exists("Assets/VRTrainingKit/Plugins");
            bool coreExists = Directory.Exists("Assets/VRTrainingKit/Scripts/Core");
            ...
            {
                var guidePath = "Assets/VRTrainingKit/Documentation/DLL_EXPORT_STEPS.md";
        ...
        private void PrepareForExport()
        {
            ...
            try
            {
                ...
                string pluginsPath = "Assets/VRTrainingKit/Plugins";
        ...
        {
            // Select the VRTrainingKit folder
            var vrtkFolder = AssetDatabase.LoadAssetAtPath<Object>("Assets/VRTrainingKit");
            if (vrtkFolder != null)
            {
            ...
            EditorUtility.DisplayDialog(
                "Export Package",
                "The VRTrainingKit folder is now selected.\n\n" +
                "Steps:\n" +
