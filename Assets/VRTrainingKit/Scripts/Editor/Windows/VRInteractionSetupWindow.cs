...
public class VRInteractionSetupWindow : EditorWindow, ISequenceTreeViewCallbacks
{
    ...
    // Sequence tab - Now uses extracted SequenceTreeView (Phase 4) and SequencePropertiesPanel (Phase 5)
    ...
    // Details panel scroll - now delegates to SequencePropertiesPanel (Phase 5)
    private Vector2 detailsPanelScrollPos
    {
        get => _sequencePropertiesPanel?.ScrollPosition ?? Vector2.zero;
        set { if (_sequencePropertiesPanel != null) _sequencePropertiesPanel.ScrollPosition = value; }
    }
    ...
    private void OnEnable()
    {
        ...
        // Initialize Sequence properties panel
        _sequencePropertiesPanel = new SequencePropertiesPanel(AutoSaveCurrentAsset);
    ...
    private void DrawTwoPanelLayout()
    {
        ...
        // Delegate to SequencePropertiesPanel (Phase 5 extraction)
        _sequencePropertiesPanel?.Draw(selectedHierarchyItem, selectedItemType);
        EditorGUILayout.EndVertical();
    ...
    // NOTE: DrawDetailsContent moved to SequencePropertiesPanel (Phase 5)
    ...
    // NOTE: DrawSelectedItemProperties, DrawProgramProperties, DrawModuleProperties,
    // DrawTaskGroupProperties, DrawStepProperties moved to SequencePropertiesPanel (Phase 5)
