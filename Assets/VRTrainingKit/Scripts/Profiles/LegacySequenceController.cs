// LegacySequenceController.cs
// Extracted from InteractionSetupService.cs for better organization
// This is the legacy state-based sequence system
using UnityEngine;
...
/// <summary>
/// Legacy sequence controller - controls the sequence and state flow of training scenarios
/// NOTE: This is the old system - new sequences should use TrainingSequenceController
/// </summary>
public class LegacySequenceController : MonoBehaviour
{
    [System.Serializable]
    ...
    {
        Debug.Log($"[Legacy Sequence] Object snapped: {snappedObject.name} -> {snapPoint.name}");
    ...
    {
        Debug.Log($"[Legacy Sequence] Object unsnapped: {unsnappedObject.name} from {snapPoint.name}");
    ...
    {
        Debug.Log($"[Legacy Sequence] Transitioning from {currentStateGroup?.groupName} to {newGroup.groupName}");
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Box("Legacy Sequence Controller Debug");
